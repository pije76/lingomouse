# Generated by Django 4.1.2 on 2022-11-14 01:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('literal_translation', models.CharField(blank=True, default='', max_length=200, verbose_name='literal translation')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is active')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='words', to='course.course')),
