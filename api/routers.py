...
from .views import *
# from .api.views import CourseViewSet, CourseDetailViewSet
...
urlpatterns = [
	...
	# path('<int:id>/', CourseViewSet.as_view({'get': 'retrieve',}), name="course_detail"),
	# path('<pk>/', CourseDetailViewSet.as_view(), name="course_detail"),
